...
public class KeyFactory {
    ...
    public static final FieldTypeCustomizer STORE_CLASS_AS_STRING = new FieldTypeCustomizer() {
        public void customize(CodeEmitter e, int i, Type type) {
            if(type.equals(Constants.TYPE_CLASS)){
                e.invoke_virtual(Constants.TYPE_CLASS,GET_NAME);
            }
        }
        public Type getOutType(int i, Type type) {
            if(type.equals(Constants.TYPE_CLASS)){
    ...
    public static KeyFactory create(Class keyInsterface){
        return create(keyInsterface,null);
    }

    private static KeyFactory create(Class keyInsterface, Customizer customizer) {
        return create(keyInsterface.getClassLoader(),keyInsterface,customizer);
    }
    ...
    public static class Generator extends AbstractClassGenerator{
        ...
        public void generateClass(ClassVisitor v) throws Exception {
            ...
            //如果该类的返回值没有的话,那么将抛出异常
            if(!newInstance.getReturnType().equals(Object.class)){
                throw new IllegalArgumentException("newInstrance method must return Object");
            }
